    ...
    <div className="container-profile">
      ...
      <div className='profile-grid' id="profile">
        <div className='profile-content'>
          ...
          Matriarchy est un collectif souhaitant créer un système alternatif au patriarcat au travers de retraites, ateliers et contenus pédagogiques. Nous fonctionnons en tant qu’association de type loi 1901 et souhaitons construire un espace de connexions autour de nos 3 valeurs clés: </p>
