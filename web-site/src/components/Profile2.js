    ...
    <div className="container-profile2">
      ...
      <div className='profile2-grid'>
        <div className='profile-content2'>
          ...
          <p>Exploratrice et inspirée par des univers magiques et passionnants, <strong>je vous accompagne dans une aventure alliant le bien-être avec soi et son rapport aux autres.</strong></p>
