        ...
        <div className='cards'>
          ...
          <div className="card-ateliers-yoga">
            <p className="title-cards"><strong> Yoga Vinyasa (tous niveaux) </strong></p>
              <img src="https://images.unsplash.com/photo-1603988363607-e1e4a66962c6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80" className="image-yoga" alt="image d'une femme faisant du yoga pour les ateliers yoga"/>
            <div className="text">
          ...
          <div className="card-ateliers-chaman">
            ...
            <img src={tambour} className="image-tambour" alt="image d'un tambour chamanique pour les ateliers voyage au tambour"/>
            <div className="text">
          ...
          <div className="card-ateliers">
            ...
            <img src="https://images.unsplash.com/photo-1573164574230-db1d5e960238?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" className="image-yoga" alt="image ambiance de travail pour les ateliers coaching" />
            <div>
