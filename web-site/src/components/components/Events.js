    ...
    <div className="events-container" id="events">
      ...
      <div className='banner-container3'>
        <div className="image-banner-events" >
          <Topbar />
          <img src={Programme} className="image-events" alt="bannière avec de la peinture ocre en arrière plan avec l'intitulé Programme"/>
        </div>
      </div>
      {/* ---------------- */}
      <h1 className='apropos-title2'> Un programme varié et intense !</h1>
