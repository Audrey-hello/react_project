...
import { GroupData, GroupQuery, GroupSubscriberData, GroupSubscriberFlags, SubscriberGroupQuery, SubscriberType } from '../@types';
...
export default function (client: AxiosInstance): {
    ...
    createGroup(group: GroupData): Promise<import("axios").AxiosResponse<any>>;
    updateGroup(groupId: number, groupUpdate: GroupData): Promise<import("axios").AxiosResponse<any>>;
    removeGroup(groupId: number): Promise<import("axios").AxiosResponse<any>>;
